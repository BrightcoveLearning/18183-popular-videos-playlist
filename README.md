...
# 18183-popular-videos-playlist
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-popular-videos-playlist.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>popular-videos.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>popular-videos.css</strong>.</td>
    </tr>
  </tbody>
</table>
